...
import (
	...
	cli2 "github.com/pundix/pundix/x/ibc/applications/transfer/client/cli"
	keeper2 "github.com/pundix/pundix/x/ibc/applications/transfer/keeper"
...
func (am AppModule) RegisterStoreDecoder(sdr sdk.StoreDecoderRegistry) {
	sdr[types.StoreKey] = simulation2.NewDecodeStore(am.keeper)
}
