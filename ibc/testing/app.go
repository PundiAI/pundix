...
var DefaultTestingAppInit func() (ibctesting.TestingApp, map[string]json.RawMessage) = pxapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibctesting.TestingApp {
	...
	stakingParams.BondDenom = pxtypes.StakingBondDenom()
	...
	for _, b := range balances {
		...
		totalSupply = totalSupply.Add(b.Coins.Add(sdk.NewCoin(pxtypes.StakingBondDenom(), bondAmt))...)
	}

	// add bonded amount to bonded pool module account
	balances = append(balances, banktypes.Balance{
		Address: authtypes.NewModuleAddress(stakingtypes.BondedPoolName).String(),
		Coins:   sdk.Coins{sdk.NewCoin(pxtypes.StakingBondDenom(), bondAmt)},
	})
	...
	app.InitChain(
		abci.RequestInitChain{
			...
			ConsensusParams: pxapp.GetDefaultConsensusParams(),
