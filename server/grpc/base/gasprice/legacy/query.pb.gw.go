...
var (
	pattern_Query_GasPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"other", "v1", "gas_price"}, "", runtime.AssumeColonVerbOpt(true)))
)
