...
type AppKeepers struct {
	...
	MintKeeper       pundixmintkeeper.Keeper
	...
	PundixTransferKeeper pundixtransferkeeper.Keeper
	FeeGrantKeeper       feegrantkeeper.Keeper
	AuthzKeeper          authzkeeper.Keeper

	// Modules
	TransferModule       transfer.AppModule
	PundixTransferModule pundixtransfer.AppModule
...
func NewAppKeeper(
	...
	appKeepers.MintKeeper = pundixmintkeeper.NewKeeper(
		appCodec,
	...
	*/
	...
	appKeepers.PundixTransferKeeper = pundixtransferkeeper.NewKeeper(
	...
	ibcRouter.AddRoute(ibctransfertypes.ModuleName, pundixIBCMiddleware)
