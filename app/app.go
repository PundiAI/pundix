...
func NewPundixApp(
	...
	anteHandler, err := pundixante.NewAnteHandler(
		pundixante.HandlerOptions{
...
func (app *PundixApp) Name() string { return app.BaseApp.Name() }
...
func (app *PundixApp) setupUpgradeStoreLoaders() {
...
func (app *PundixApp) setupUpgradeHandlers() {
	for _, upgrade := range Upgrades {
